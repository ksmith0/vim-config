...
if !exists("c_no_cern_root")
   ...
   syn keyword	cType		TCut TCutG
   syn keyword	cType		TKDE
   syn keyword	cType		TFitResultPtr
   syn keyword	cType		TGraph TMultiGraph TGraph2D TGraphErrors TGraphAsymmErrors
   syn keyword	cType		THStack TCanvas TRandom TLimit 
	syn keyword	cType		TText TLatex
	syn keyword	cType 	TPave TPaveStats TPaveText	
	syn keyword	cType 	TTree TEventList TEntryList
   syn keyword	cType		TNtuple TObject TObjArray
	syn keyword cType		TIter TKey TRandom2 TShape TPad TMacro
	syn keyword cType		TPROOF TSelector
   ...
   syn keyword	cType           TChain TDirectory TList TArc TFrame TBox TEllipse TPolyLine TCurlyLine TCurlyArc TEllipse
   ...
   syn keyword	cConstant       kBlack kWhite kGray kRed kPink kBlue kMagenta kViolet kAzure kCyan kTeal kGreen kSpring kYellow kOrange
